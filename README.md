...
My primary concern or challenge is to produce videos that are effective and accessible. In terms of accessibility, the display size on the students' Chromebooks is a concern. I need to be mindful of this when producing videos and presentations that students will display on their 11.6" monitors. I will also make the content in the videos available in non-video formats for students who do not have fast internet access at home. 

In terms of producing vidoes that are effective, I need to keep in mind the multimedia principles and I also need to establish a workflow that is sustainable so that I can keep making effective videos throughout the semester. I need to plan out the curriculum with specific objectives that build on prior lessons so that I can keep the videos short and focused (coherence principle and segmentation principle). I will record my screen for "coding" demonstrations, then add audio later (voice principle and redundancy principle), which I find much less time consuming then narrating while recording. When the purpose of the video is to emphasize key vocabulary or syntax, I will use the ink replay feature to add text near graphics (spatial contiguity principle) and to highlight text (signaling principle).
